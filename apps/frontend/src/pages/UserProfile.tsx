...
export default function UserProfile() {
  ...
  const [form, setForm] = useState({
    ...
    lastName: user?.last_name || 'Mercer',
  ...
  const handleChangePhoto = () => {
    const url = prompt('Enter new avatar URL:', user?.photo_url || 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&q=80&w=200');
        ...
        <div className="space-y-6">
          ...
          <div className="card p-6 text-center">
            <div className="relative w-28 h-28 mx-auto mb-4">
              <img
                src={user?.photo_url || '/images/user-avatar.jpg'}
                alt="Profile"
            ...
            <h2 className="text-lg font-bold text-[#0b1c30] font-heading">
              {user?.first_name || 'Alex'} {user?.last_name || 'Mercer'}
            </h2>
