          ...
          <div className="p-6 lg:p-8">
            {step === 1 && (
              <div className="space-y-6">
                ...
                {/* Cover Photo Upload */}
                <div 
                  className={`border-2 ${form.coverImage ? 'border-solid border-[#e2e8f0]' : 'border-dashed border-[#e2e8f0]'} rounded-2xl text-center hover:border-[#E8604C]/40 transition-colors cursor-pointer relative overflow-hidden h-48 flex flex-col items-center justify-center`}
                ...
                >
                  ...
                  {form.coverImage ? (
                    <>
                      <img src={form.coverImage} alt="Cover Preview" className="absolute inset-0 w-full h-full object-cover" />
                      <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                        <Camera className="w-8 h-8 text-white mb-2" />
                        <p className="text-sm text-white font-medium">Change photo</p>
                      </div>
                    </>
                  ) : (
                    <>
